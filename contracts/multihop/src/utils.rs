...
mod tests {
    ...
    fn verify_operations_in_swap_should_work() {
        ...
        let token1 = Address::from_string(&String::from_str(
            &env,
            "CDF2CJ26YHWB37JYTUFS722WJBJPG5OP5XN4TGZZPCEEUWHEIMGQG2O3",
        ));
        let token2 = Address::from_string(&String::from_str(
            &env,
            "CB64D3G7SM2RTH6JSGG34DDTFTQ5CFDKVDZJZSODMCX4NJ2HV2KN7OHT",
        ));
        let token3 = Address::from_string(&String::from_str(
            &env,
            "CAM3XZFCVAG6KJQUIAW2YWCGZQJ6CR6QIAQ5MAWU7GMM4ZZZCJ7JVDSH",
        ));
        let token4 = Address::from_string(&String::from_str(
            &env,
