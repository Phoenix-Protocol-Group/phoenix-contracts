...
use soroban_sdk::{testutils::arbitrary::std, Address, Env, String, Symbol, Vec};
...
#[test]
#[should_panic(
    expected = "Factory: Create Liquidity Pool: You are not authorized to create liquidity pools!"
)]
fn factory_fails_to_init_lp_when_authorized_address_not_present() {
    ...
    let unauthorized_addr = Address::from_string(&String::from_str(
        &env,
        "GCHM6Y4BYTUJZQ4KABLTC73IWDZNFBZ2NML5W4AQG7XAJEOMLF5I774H",
    ));
