...
use phoenix_stake::msg::WithdrawableRewardsResponse;
use super::setup::{deploy_staking_rewards_contract, deploy_token_contract};

use crate::msg::{AnnualizedRewardResponse, WithdrawableRewardResponse, WithdrawableRewardsResponse};
...
fn two_users_one_starts_after_distribution_begins() {
    ...
    assert_eq!(
        staking.query_withdrawable_rewards(&user1),
