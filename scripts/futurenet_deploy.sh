...
TOKEN_ADDR1="CAS3J7GYLGXMF6TDJBBYYSE3HQ6BBSMLNUQ34T6TZMYMW2EVH34XOWMA" # XLM MAINNET
TOKEN_ADDR2="CCW67TSZV3SSS2HXMBQ5JFGCKJNXKZM7UQUWUZPUTHXSTZLEO7SJMI75" # USDC mainnet
#
...
soroban contract invoke \
    ...
    --lp_init_info "{ \"admin\": \"${ADMIN_ADDRESS}\", \"share_token_decimals\": 7, \"swap_fee_bps\": 1000, \"fee_recipient\": \"${ADMIN_ADDRESS}\", \"max_allowed_slippage_bps\": 10000, \"max_allowed_spread_bps\": 10000, \"max_referral_bps\": 5000, \"token_init_info\": { \"token_a\": \"${TOKEN_ADDR1}\", \"token_b\": \"${TOKEN_ADDR2}\" }, \"stake_init_info\": { \"min_bond\": \"100\", \"min_reward\": \"100\", \"max_distributions\": 3, \"manager\": \"${ADMIN_ADDRESS}\" } }" \
    --share_token_name "XLMUSDCST" \
    --share_token_symbol "XUST"
...
soroban contract invoke \
    ...
    -- \
    provide_liquidity --sender $ADMIN_ADDRESS --desired_a 300000000 --desired_b 40000000
